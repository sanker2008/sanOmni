...
for (const rel of files) {
  ...
  // Replace `let app_data_dir = app_handle.path().app_data_dir()...` with base_app_data_dir
  ...
  // Also handle .ok_or_else(|| "Failed to get app data directory".to_string())?
...
console.log('Fixed works.rs and characters.rs');
