...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::images::get_ip_inbox_images,
            commands::images::get_archived_images,
            commands::images::get_ip_archived_images,
            ...
            commands::ip_assets::get_ip_characters_for_image,
            commands::ip_assets::set_ip_characters_for_image,
