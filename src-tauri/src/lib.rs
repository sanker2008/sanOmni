...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::images::update_image_file,
            ...
            commands::chapters::get_chapter_by_id,
            commands::chapters::update_chapter,
            commands::chapters::delete_chapter,
            commands::chapters::update_chapter_order,
            commands::chapters::set_chapter_characters,
            commands::chapters::set_chapter_images,
            ...
            commands::knowledge::index_knowledge_project,
            commands::knowledge::import_knowledge_web_collection,
            ...
            commands::fs::secure_fs_is_animated_image,
            commands::fs::secure_fs_write_file,
            commands::fs::secure_fs_append_file,
