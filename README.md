...
- ☁️ **云端同步** - 工业级双向同步引擎，内置底层触发器、CAS 去重存储，配套专属服务端 🆕
...
- [文件扫描](./docs/FOLDER_MONITORING.md) - 自动扫描文件夹导入或清理图片
...
### 📝 更新日志
- [云端双向同步与独立服务端 (2026-06-08)](./docs/CHANGELOG_2026-06-08_SYNC_FEATURE.md) 🆕
- [目录迁移与数据修复系统完善 (2026-06-02)](./docs/CHANGELOG_2026-06-02_DIRECTORY_MIGRATION_REPAIR.md)
- [统一根目录功能 (2026-06-01)](./docs/CHANGELOG_2026-06-01_UNIFIED_ROOT.md) 🆕
...
- **如何自动导入缺失图片？** → [文件扫描功能](./docs/FOLDER_MONITORING.md)
...
**最后更新：** 2026-06-02  
**版本：** 1.0.1  
**最新功能：** 并在 sanLabs 工具箱中新增了“PNG 转 SVG”小工具 🆕
